...
})(window.WebComponents);/*! echo-js v1.7.3 | (c) 2016 @toddmotto | https://github.com/toddmotto/echo */
...
function initializeEcho() {
    if (ECHOINITIALIZED) {
        console.log('Re-initializing echo.');
    };
    ECHOINITIALIZED = true;
    echo.init({ offset : 100, throttle : 250, unload : null });
};
function echoWatchScrolling(containerId) {
    id(containerId).addEventListener('content-scroll', echoHandleScroll);
};
function echoHandleScroll() {
    echo.render();
...
function visitTickets() {
    visitUrl('http://www.meetup.com/Montana-Programmers/events/231091271/');
};function viewTestersMessage() {
    visitUrl('/documents/Senator-Tester-Spring-2016-Hackathon-Message.pdf');
...
function setupLife() {
    var _js2 = LIFESIZE - 1;
    for (var row = 0; row <= _js2; row += 1) {
        var _js3 = LIFESIZE - 1;
        for (var col = 0; col <= _js3; col += 1) {
